        ...
        <div className="font-mulish flex flex-col">
            ...
            <div className="flex flex-col gap-3">
                ...
                <svg
                    ...
                    <div className="flex flex-wrap font-mulish font-bold text-black">
                        Disable Simulation <br />
                        Mode (Enabled)
                    </div>
                </div>
                <div className="flex gap-2">
                <button className="rounded-full bg-red-300 h-fit w-fit inline-flex justify-center items-center cursor-not-allowed opacity-40">
                <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-12 w-12"
                            viewBox="0 0 20 20"
                ...
                <div className="flex gap-2 items-center">
                    <button className="rounded-full bg-red-300 h-12 w-12 inline-flex justify-center items-center cursor-not-allowed opacity-40">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-8 w-8"
                            fill="none"
